...
public class Cuidador implements Serializable {
	...
	public void setDatos(int codCuidador) {
		LocalDate probarFecha1;
		LocalDate probarFecha2;
		...
		while (pasarseFecha) {
			...
			probarFecha1 = Util.leerFechaDMA();
			pasarseFecha = fechaNacimientoCorrecta(probarFecha1, pasarseFecha);

			while (!pasarseFecha) {
				System.out.println("\nIntroduce la fecha de alta del cuidador: (DD/MM/AAAA) ");
				probarFecha2 = Util.leerFechaDMA();
				pasarseFecha = comprobacionFechaAltaMayorAlActual(probarFecha2, pasarseFecha);
			}
		}
